...
export const drawClip = (chartStructure: ChartStructure, chart: LineChart) =>{
    chartStructure.chartGroup
            ...
            .append("svg:rect")
            .attr("width", chart.getClientWidth() - chart.verticalAxis.offset.right - chart.verticalAxis.offset.left)
            .attr("height",chart.getClientHeight() - chart.horizontalAxis.offset.bottom - chart.horizontalAxis.offset.top)
